...
- [DEMO LINK](https://Urszula-M.github.io/layout_stars/)
- [TEST REPORT LINK](https://Urszula-M.github.io/layout_stars/report/html_report/)
...
- [ ] Code follows all the [Code Style Rules ❗️](./chenpm run lintcklist.md)
